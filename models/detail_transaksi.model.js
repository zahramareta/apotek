 ...
 */
 ...
 exports.findAll = () => {
     return new Promise((resolve, rejected) => {
         ...
         let query = `select * from ${tableName} join obat on obat.id = transaksi.id_obat`
 ...
 exports.findByCriteria = (parameter) => {
     return new Promise((resolve, rejected) => {
         ...
         /** define query to get all data */
         let query = `select * from ${tableName} join obat on obat.id = detail_transaksi.id_obat where ${params}`
